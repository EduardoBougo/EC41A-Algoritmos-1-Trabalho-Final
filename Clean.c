...
int validarNome(char nome[50]) { // (1) Verdadeiro -- (0) Falso 
...
int contemSomenteLetras(char text[50]) { // (1) Verdadeiro -- (0) Falso 
...
int validarTelefone(char telefone[15]) { // (1) Verdadeiro -- (0) Falso 
